...
export default function HomePage() {
  ...
  return (
    <div className="relative w-auto h-screen flex justify-center items-center bg-[#FFFBE6] font-sans">
      ...
      <div
        className={`absolute top-20 left-3 z-10 shadow-lg bg-white rounded-xl transition-all duration-300 ease-in-out ${
          sidebarOpen ? "w-[26rem]" : "w-56"
        }`}
      >
        <div className="flex justify-between items-center">
          <p
            className={`ml-5 py-2 font-semibold text-xl w-full border-b-2 ${
        ...
        <div
          className={`w-full max-h-[26rem] overflow-scroll ${
            sidebarOpen ? "" : "hidden"
          }`}
        >
          {happeningAccidents.map((accident, i) => (
            <div
              key={i}
              className="w-full h-26 border-b py-2 px-5 flex justify-between items-center gap-2 cursor-pointer"
            ...
            >
              ...
              <div className="w-3/5 h-full py-2 pl-3 flex flex-col items-start">
                ...
                <p
                  alt={accident.desc}
                  className="text-xs text-slate-500 font-normal italic overflow-hidden text-ellipsis text-justify"
                >
                  {accident.desc}
                </p>
                ...
                onClick={() => {
                  ...
                  setTimeout(() => {
                    navigate("/report-form", {
                      state: { accidentName: accident.name },
                    });
                  }, 2000);
                }}
              />
